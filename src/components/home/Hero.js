      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6 lg:px-16">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight mb-6">
            Empower Your Success with <span className="text-[#91e0ed]">Integral IQ</span>
          ...
          <div className="flex justify-center md:justify-start">
            <button className="px-8 py-4 bg-[#91e0ed] text-[#00375e] hover:bg-[#d8f2f7] hover:scale-110 rounded-full text-lg font-semibold transition">
              Get Started
            </button>
            <button className="ml-4 px-8 py-4 bg-white text-[#00375e] hover:bg-[#d9f7fb] hover:translate-x-5 rounded-full text-lg font-semibold transition">
              Learn More
            </button>
          </div>
        </div>
        ...
        <motion.div className="w-full md:w-1/2 flex justify-center mb-8 md:mb-0"
          ...
          <img
            src="/hero.png"
            alt="Hero Animation"
            className="w-4/5 md:w-full max-w-lg"
          />
